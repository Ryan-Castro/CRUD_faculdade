...
export default function PacientCard(props:{pacient: Pacient, handleModalShow: Dispatch<SetStateAction<number>>}) {
    ...
    return (
      <div className="text-black bg-gray-400 mb-2 flex justify-between px-6 py-4">
          ...
          <div className="flex gap-4 items-center">
            ...
            <button className="bg-yellow-400 rounded-2xl px-4 p-1" onClick={()=>{props.handleModalShow(1)}}>Editar</button>
